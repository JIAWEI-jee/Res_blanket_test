...
static void Voltg_calc ( u16* ch0_v,u16* ch1_v,u16* ch2_v,u16* ch3_v )
{
	...
	ch0_ad_value = ch0_ad_value/4095*2000;
	* ch0_v = ch0_ad_value;
	KEY_printf ( "rtemper1 = %d \r\n",ch0_ad_value ); //pjw set

	
	KEY_printf ( "adv1 = %d \r\n",ch1_ad_value ); //pjw set
	ch1_ad_value = ch1_ad_value/4095;
	KEY_printf ( "adv1_temp = %d \r\n",ch1_ad_value ); //pjw set
	ch1_ad_value = ch1_ad_value*2000;
	* ch1_v = ch1_ad_value;
	KEY_printf ( "rtemper2 = %d \r\n",ch1_ad_value ); //pjw set

	
	KEY_printf ( "adv2 = %d \r\n",ch2_ad_value ); //pjw set
	ch2_ad_value = ch2_ad_value/4095*2000;
	* ch2_v = ch2_ad_value;
	KEY_printf ( "heat1 = %d \r\n",ch2_ad_value ); //pjw set

	
	KEY_printf ( "adv3 = %d \r\n",ch3_ad_value ); //pjw set
	ch3_ad_value = ch3_ad_value/4095*2000;
	* ch3_v = ch3_ad_value;
	KEY_printf ( "heat2 = %d \r\n",ch3_ad_value ); //pjw set
